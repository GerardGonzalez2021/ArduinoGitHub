...
digitalWrite(led0, HIGH);    // posar a 5V el pin 5
 ...
 digitalWrite(led0, LOW);     // posar a 0V el pin 5 
  ...
  digitalWrite(led7, HIGH);    // posar a 5V el pin 5
  delay(temps);
 digitalWrite(led7, LOW);     // posar a 0V el pin 5 
 
  digitalWrite(led6, HIGH);    // posar a 5V el pin 6
   delay(temps);
  digitalWrite(led6, LOW);     // posar a 0V el pin 6

  digitalWrite(led5, HIGH);    // posar a 5V el pin 7
   delay(temps);
  digitalWrite(led5, LOW);     // posar a 0V el pin 7

  digitalWrite(led4, HIGH);    // posar a 5V el pin 8
   delay(temps);
  digitalWrite(led4, LOW);     // posar a 0V el pin 8
 
  digitalWrite(led3, HIGH);    // posar a 5V el pin 9
   delay(temps);
  digitalWrite(led3, LOW);     // posar a 0V el pin 9
   
  digitalWrite(led2, HIGH);    // posar a 5V el pin 10
   delay(temps);
  digitalWrite(led2, LOW);     // posar a 0V el pin 10
 
  digitalWrite(led1, HIGH);    // posar a 5V el pin 11
   delay(temps);
  digitalWrite(led1, LOW);     // posar a 0V el pin 11
